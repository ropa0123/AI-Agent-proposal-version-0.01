...
system_instructions = (
    ...
    # --- ENHANCED INSTRUCTION FOR RESULTS ACCESS ---
...
class ZIMSECApp:
    ...
    def chat_ui(self):
        ...
        * { box-sizing: border-box; }
        ...
        .logout {
          background:transparent; color:#9aa3b2; border:none; cursor:pointer; font-size:14px;
        }
            ...
            <div class="chat-panel">
                ...
                <div class="right">
                    ...
                    <div class="input-wrap">
                        <div class="input">
                            <input id="user_input" placeholder="Type your ZIMSEC question..." />
                        </div>
